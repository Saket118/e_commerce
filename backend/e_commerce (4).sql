...
CREATE TABLE `users` (
  ...
  `designation` varchar(25) NOT NULL DEFAULT 'user',
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `designation`, `phoneNo`, `gender`, `status`) VALUES
(1, 'Saket Shrivastava', 'saket@gmail.com', '12345', 'admin', '8109149253', 'Male', 'active'),
